...
func _process(delta: float) -> void:
	var sun_dir: Vector3 = sun.get_global_transform().basis.z; # This is our forward direction pointing towards the sun
	var moon_dir: Vector3 = moon.get_global_transform().basis.z; # This is our forward direction pointing towards the moon
